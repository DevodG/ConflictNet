...
ckpt = load_checkpoint_state(CKPT, device=DEVICE)
...
out_dir = Path("/teamspace/studios/this_studio/conflictnet/benchmark_results")
...
json.dump(report, open(str(out_dir / "cremad_metrics.json"), "w"), indent=2)
